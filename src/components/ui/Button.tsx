...
const buttonVariants = cva('flex items-center justify-center rounded-md font-medium text-white duration-300 dark:text-black disabled:hover:bg-indigo-400 disabled:cursor-not-allowed ', {
  variants: {
    variant: {
      // ** FILLED
      default: 'bg-slate-900 dark:bg-indigo-500 dark:text-white dark:hover:bg-indigo-700 ',
